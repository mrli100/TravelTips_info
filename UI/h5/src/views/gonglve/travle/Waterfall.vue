...
const totalWidth = computed(() => {
  ...
  var width = (document.body.clientWidth-60)+'px'
...
<template>
  ...
  <div v-if="mode==='CSS'" v-bind="$attrs" class="m-waterfall-css" :style="`background: ${backgroundColor}; width: ${totalWidth}; padding: 30px 30px 60px 30px; column-count: ${columnCount}; column-gap: ${columnGap}px;`">
    <Spin
