...
public class GeneratorConfig {
    ...
    public net.maku.generator.config.template.GeneratorInfo getGeneratorConfig() {
        ...
        try {
            ...
            net.maku.generator.config.template.GeneratorInfo generator = JsonUtils.parseObject(configContent, net.maku.generator.config.template.GeneratorInfo.class);
            for (net.maku.generator.config.template.TemplateInfo templateInfo : generator.getTemplates()) {
                // 模板文件
